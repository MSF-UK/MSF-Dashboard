...
g.module_lang.text.fra = {
	main_title: 'MSF Dashboard v1.1 | Surveillance Sud-Kivu',
	...
	chartwarper_btn_container_ser_outer:'toutes les semaines',
...
g.module_lang.text.eng = {
	...
	chartwarper_btn_container_ser_outer:'all weeks',
...
g.module_lang.text.cas = {
	main_title: 'MSF Dashboard v1.0.0 | Surveillance Sud-Kivu',
    ...
    map_unit_title: {
        ...
        IncidenceProp: 'Proporción de Incidencia (/100,000 personas)',
        Deaths: 'Numero de Fallecimientos',
		MortalityProp: 'Proporción de Mortalidad (/100,000 personas)',
    ...
    chartwarper_tab_containter_bar:'Todas las semanas',
