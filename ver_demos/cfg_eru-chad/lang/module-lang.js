...
g.module_lang.text.fra = {
	main_title: 'MSF Dashboard v1.3 | Surveillance Chad ERU',
	...
	calc_ir: "Taux d\'Incidence = (Nombre de Cas * 100,000) / (Population de la Région ou du District * Nombre de Semaines)",
	calc_mr: "Taux de Mortalité = (Nombre de Décès * 100,000) / (Population de la Région ou du District * Nombre de Semaines)",
...
g.module_lang.text.eng = {
	...
	calc_ir: "Incidence Rate = (Number of Cases * 100,000) / (Population of Region or District * Number of Epiweeks)",
	calc_mr: "Mortality Rate = (Number of Deaths * 100,000) / (Population of Region or District * Number of Epiweeks)",
