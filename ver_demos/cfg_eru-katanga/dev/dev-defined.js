...
//g.module_colorscale.qualitative_colors = ['#333333', '#17becf', '#bcbd22', '#428bca', '#f69318','#9467bd', '#1b9e77', '#66a61e'];
...
g.module_getdata = {
    ...
    extralay:{
        admN0:{
            method: 'd3',
            options: {  url: './data/geo_prov.geojson',
                        type: 'json'}
        }
    },
    medical:{
    ...
    population:{
        pop: {
            method: 'populationd3',
            options: {  url: './data/pop_katanga.csv',
                        type: 'csv'}   
        }
    }
};
