...
g.module_getdata = {
    geometry: {
        admN1: {
            method:  'geometryd3',
            options: {  url: './data/geo_adm7.geojson',
                        type: 'json'}
            },
        admN2: {
            method:  'geometryd3',
            options: {  url: './data/geo_adm8.geojson',
                        type: 'json'}
            },
        admN3: {
            method:  'geometryd3',
            options: {  url: './data/geo_adm9.geojson',
                        type: 'json'}
            }
    },
    extralay:{
    ...
    medical:{
        medical: {
            ...
            options: {  url: 'input/lubumbashi_cholera_wks-201301-201321.txt',
                        type: 'tsv'}      
        }
    },
    population:{
...
g.medical_headerlist = {
    ...
    admN3: 'Geo_L3',    // Name of administrative/health division level N3
...
g.module_datacheck.definition_value = {
    ...
    admN3:  {test_type: 'ingeometry',   setup: 'none'}, // Name of division level N1 
