...
g.module_lang.text.fra = {
	main_title: 'MSF Dashboard v1.3 | Surveillance DRC KERE',
	main_description: ['VERSION PILOTE prend en entrée des données de surveillance', 'Dévelopé par la Manson Unit, MSF UK - <a href="mailto:gis.mansonunit@london.msf.org">gis.mansonunit@london.msf.org</a>'],
	src_txt: 'Fichier Source',
	...
	chart_case_ser_comp_title: 'Cas & Décès - Complétude',
	chart_case_lin_comp_title: 'Cas & Décès - Complétude',
	...
	chart_comp_labely: 'Complétude',						
	chart_year_title: 'Années',					
	chart_fyo_labela: ' Tous Ages',   	
	chart_fyo_labelu: ' Moins de 5ans', 
	chart_fyo_labelo: ' Plus de 5ans',
	chart_fyo_title: 'Ages', 					
	chart_multiadm_title: 'Emplacements', 					
	chart_ser_range_title: 'Semaine Epi',	

	chart_popup_label_week: 'Semaine',
	chart_popup_label_value: 'Valeur',	
	chart_popup_label_rate: 'Taux',
	chart_popup_label_na: 'Données non disponibles',	
	...
	calc_ir: "Taux d\'Incidence = (Nombre de Cas * 100,000) / (Population de la Province ou de la Zone * Nombre de Semaines)",
	calc_mr: "Taux de Mortalité = (Nombre de Décès * 100,000) / (Population de la Province ou de la Zone * Nombre de Semaines)",
	...
	datatable_text: {
        ...
        header_popup: ['Cliquez içi pour trier par ',' (lorsque vous cliquez dessus, la flèche sur la drote est rouge'],
        footer_text: ['Total', 'Total de table'],
        search_note: 'Note: La recherche dans la table ne filtre pas les données dans le reste du dashboard',
        language: {
	...
	intro_case_ser: "<div style='font: 14px sans-serif;'><h4><b>Graphique de semaine épidémiologique - continu</b></h4><p>Ces graphiques représentent les nombres ou les taux par semaine épi comme une série chronologique continue pour chaque groupe d'âge ainsi que tous les âges combinés.</p><p>Ils ne permettent pas de filtrer les données. Cependant, ils sont automatiquement zoomés sur les semaines épi sélectionnées dans le <i>graphique de sélection de semaines épi</i> ci-dessous.</p></div>",

	intro_case_lin: "<div style='font: 14px sans-serif;'><h4><b>Graphique de semaine épidémiologique - par année</b></h4><p>Ces graphiques représentent les nombres ou les taux (pour tous les <i>âges combinés</i>) par semaine épi et par année.</p><p>Ils ne permettent pas de filtrer les données. Cependant, ils sont automatiquement zoomés sur les semaines épi sélectionnées dans le <i>graphique de sélection de semaines épi</i> ci-dessous.</p><p>Pour visualiser les données du dashboard uniquement pour certaines années, il est possible de filtrer les années directement sur le graphique des <i>Années</i> (diagramme circulaire).</p></div>",
	...
	intro_fyo: '<div style="font: 14px sans-serif;"><h4><b>Graphique par classe d\'âge</b></h4><p>Ce diagramme circulaire représente le nombre de cas par classe d\'âge (+ ou - de 5 ans).</p><p>Cliquez sur les sections du diagramme pour filtrer par classe d\'âge toutes les données du dashboard.</p></div>',

	intro_year: "<div style='font: 14px sans-serif;'><h4><b>Graphique par année</b></h4><p>Ce diagramme circulaire représente le nombre de cas par année en pourcentage du total.</p><p>Cliquez sur les sections du diagramme pour filtrer par année toutes les données du dashboard. Il est possible de sélectionner plusieurs années simultanément pour les comparer dans le graphique de <i>Semaine épidémiologique par année.</i></p></div>",

	intro_table: "<div style='font: 14px sans-serif;'><h4><b>Tableau</b></h4><p>Ce tableau présente les entrées sélectionnées (en tenant compte de tous les filtres appliqués au dashboard).</p><p>Il est possible de trier chaque colonne ou d'effectuer une recherche dans la table. Cependant, la recherche dans la table ne filtre pas toutes les données du dashboard et les valeurs <i>Total du tableau</i> ne sont donc pas modifiées lors de la recherche dans la table.</p><p>Cliquez sur le bouton <i>Copier vers le presse-papier</i> pour copier tout le contenu du tableau (afin d'en exporter le contenu vers Excel par exemple).</p></div>",
...
g.module_lang.text.eng = {
	main_title: 'MSF Dashboard v1.3 | Surveillance DRC KERE',
	main_description: ['PILOT VERSION for surveillance data', 'Developed by MSF UK, Manson Unit: <a href="mailto:gis.mansonunit@london.msf.org">gis.mansonunit@london.msf.org</a>'],
	src_txt: 'Source File',
	...
	chart_fyo_labelu: ' Under 5yrs', 
	chart_fyo_labelo: ' Over 5yrs', 	
	chart_fyo_title: 'Age', 			
	chart_multiadm_title: 'Locations',				
	chart_ser_range_title: 'Epi-weeks',	

	chart_popup_label_week: 'Week',
	chart_popup_label_value: 'Value',
	chart_popup_label_rate: 'Rate',
	chart_popup_label_na: 'Data not available',
	...
	calc_ir: "Incidence Rate = (Number of Cases * 100,000) / (Population of Province or Zone * Number of Epiweeks)",
	calc_mr: "Mortality Rate = (Number of Deaths * 100,000) / (Population of Province or Zone * Number of Epiweeks)",
	...
	datatable_text: {
        ...
        header_popup: ['Click here to sort by ',' (when sorted the arrow on the right is red)'],
        footer_text: ['Total', 'Table Total'],
        search_note: 'Note: Searching the table does not filter the data in the rest of the dashboard',
        language: {
	...
	intro_fyo: "<div style='font: 14px sans-serif;'><h4><b>Age Pie Chart</b></h4><p>This chart displays case numbers by age group (+/- 5 years old).</p><p>Clicking a slice selects or <i>de-</i>selects all data for that age group, and filters all dashboard data accordingly.</p></div>",

	intro_year: "<div style='font: 14px sans-serif;'><h4><b>Years Pie Chart</b></h4><p>This chart displays case numbers by year as percentages of the total.</p><p>Clicking a slice selects or <i>de-</i>selects all data for that year, and filters all dashboard data accordingly. It is possible to select multiple years and compare them in the <i>Epi-week Chart by Year</i> charts.</p></div>",

	intro_table: "<div style='font: 14px sans-serif;'><h4><b>Data Table</b></h4><p>This table displays all records in the current selection (accounting for all filters applied in the dashboard).</p><p>It is possible sort each column or to search the table using the search input box. Searching the table does not filter all the dashboard data, however, and so the <i>Table Total</i> values are not changed when the table is searched.</p><p>Clicking the <i>Copy to clipboard</i> button copies the content of the entire table. This can be used to export to Excel, for example.</p></div>",
