        ...
        if (v && v.d) {
            if (_chart.hasFilter()) {
                ...
                if (isSelectedGeo(v.d)) {
                    ...
                    options.fillColor = _chart.getColor(0, v.i); // Here for 0 vs Empty
                    options.opacity = 0.8;
                    options.fillOpacity = 0.8; // #nb                                
                }
            } else {
                ...
                layer.on("mouseover",function(){
                    if(v!==undefined){
                        if(g.module_colorscale.mapunitcurrent == 'IncidenceProp' || g.module_colorscale.mapunitcurrent == 'MortalityProp'){
                            var info = _chart.popup()(feature) +": " +_chart.valueAccessor()(v.d).toFixed(2); // #nb
                        }else{
                            var info = _chart.popup()(feature) +": " +_chart.valueAccessor()(v.d).toFixed(0); // #nb
                        }
                    } else {
